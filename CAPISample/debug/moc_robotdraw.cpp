...
QT_MOC_LITERAL(11, 95, 21), // "robotConnectionStatus"
QT_MOC_LITERAL(12, 117, 14), // "startDrawTimer"
QT_MOC_LITERAL(13, 132, 13), // "stopDrawTimer"
QT_MOC_LITERAL(14, 146, 12), // "setTimerTime"
QT_MOC_LITERAL(15, 159, 2), // "ms"
QT_MOC_LITERAL(16, 162, 16), // "changeTimerSpeed"
QT_MOC_LITERAL(17, 179, 6), // "factor"
QT_MOC_LITERAL(18, 186, 7) // "getZDPx"

    },
    "RobotDraw\0drawLine\0\0start\0end\0"
    "drawPoint_Widget\0point\0thickness\0color\0"
    "robotRangeChanged\0clearGW\0"
    "robotConnectionStatus\0startDrawTimer\0"
    "stopDrawTimer\0setTimerTime\0ms\0"
    "changeTimerSpeed\0factor\0getZDPx"
};
...
void RobotDraw::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->robotConnectionStatus((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->startDrawTimer(); break;
        case 6: _t->stopDrawTimer(); break;
        case 7: _t->setTimerTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: _t->changeTimerSpeed((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 9: { float _r = _t->getZDPx();
        ...
        {
            using _t = void (RobotDraw::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotDraw::robotConnectionStatus)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void RobotDraw::robotConnectionStatus(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
