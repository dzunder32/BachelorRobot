...
#include <memory>
#include "../../../../BachelorRobot - Kopie/widget/cameracontroller.h"
...
QT_INIT_METAOBJECT const QMetaObject CameraController::staticMetaObject = { {
    QMetaObject::SuperData::link<Qt3DExtras::QAbstractCameraController::staticMetaObject>(),
...
void *CameraController::qt_metacast(const char *_clname)
{
    ...
    return Qt3DExtras::QAbstractCameraController::qt_metacast(_clname);
}

int CameraController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Qt3DExtras::QAbstractCameraController::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
